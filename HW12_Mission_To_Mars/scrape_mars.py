...
def init_browser():
    executal_path = {'executal_path': 'chromedriver.exe'}
    return Browser('chrome', **executal_path, headless=False)
...
def scrape_mars_news():
    try:
        ...
        mars_data['Headline'] = news_teaser
...
def scrape_featured_img():
    try:
        ...
        mars_data['Featured Image'] = url_img_featured
...
def scrape_mars_weather():
    try:
        ...
        mars_data['Mars Weather'] = mars_weather_tweet
...
def scrape_mars_facts():
    try:
        ...
        mars_data['Mars Facts'] = mars_html_table
